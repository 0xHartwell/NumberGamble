...
export const CONTRACT_ABI = [
  ...
  { "inputs": [ { "internalType": "uint256", "name": "gameId", "type": "uint256" }, {"internalType":"address","name":"player","type":"address"} ], "name": "getMyEncryptedRolls", "outputs": [ { "internalType": "bytes32[3]", "name": "", "type": "bytes32[3]" } ], "stateMutability": "view", "type": "function" },
